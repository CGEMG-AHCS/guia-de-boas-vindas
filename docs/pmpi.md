...
- Estimular e orientar os agentes públicos para adoção de comportamento íntegro em conformidade com a funçao e atribuição individual, com o Código de Conduta Ética do Agente Público e da Alta Administração do Poder Executivo Estadual e com o código de conduta ética específico, quando existente.

- Fomentar a incorporação de valores éticos e a adoção de medidas e de instruentos que promovam a conformidade com os normativos vigentes nas relações entre a Administração Pública e os setores público e privado.

## Qual papel a CGE-MG desempenha na PMPI?

A integridade está na missão, visão, valores e no propósito da Controladoria Geral do Estado de Minas Gerais.

A CGE é responsável pela coordenação da PMPI junto aos demais órgãos e entidades do governo estadual e pela disseminação dos valores de integridade junto à sociedade.
